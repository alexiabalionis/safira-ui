...
export const AUTOMACAO_TIPO_LABEL: Record<AutomacaoTipoKey, string> = {
  [AutomacaoTipoKey.automacao]: "Automacao",
  [AutomacaoTipoKey.semi_automacao]: "Semi-automacao",
  [AutomacaoTipoKey.manual]: "Manual",
};

export const AUTOMACAO_ETAPA_LABEL: Record<AutomacaoEtapaKey, string> = {
  [AutomacaoEtapaKey.aguardando]: "Aguardando",
  [AutomacaoEtapaKey.em_andamento]: "Em andamento",
  [AutomacaoEtapaKey.bloqueado]: "Bloqueado",
  [AutomacaoEtapaKey.finalizado]: "Finalizado",
};
...
export const AUTOMACAO_TIPO_OPTIONS = AUTOMACAO_TIPO_VALUES.map((value) => ({
  value,
  label: AUTOMACAO_TIPO_LABEL[value],
}));

export const AUTOMACAO_ETAPA_OPTIONS = AUTOMACAO_ETAPA_VALUES.map((value) => ({
  value,
  label: AUTOMACAO_ETAPA_LABEL[value],
}));
